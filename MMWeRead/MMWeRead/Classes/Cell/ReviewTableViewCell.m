...
-(void)layoutSubviews{
    ...
    //replyView
    CGFloat commentsHeight = _commentTable.contentSize.height;
...
//    CGFloat commentsHeight = (_review.hasComments?(20):0);
...
- (UIView *)tableFooterView{
    ...
    tableFooterView.frame = CGRectMake(0, 0, _commentTable.width
                                       , 20);
